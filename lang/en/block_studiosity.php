...
$string['activitytitle'] = 'Access Studiosity: After Hours Study Support';
...
$string['defaultimageurl_desc'] = 'A url for an image to use as the default image in the Studiosity block. Can also be configured per block.';
